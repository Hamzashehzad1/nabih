...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-row items-center gap-2 p-3", className)}
      {...props}
    />
  )
})
