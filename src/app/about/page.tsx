...
export default function AboutPage() {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: 'Maria is obsessed with user experience and making Content Forge intuitive.',
    },
    {
      name: 'Chen Wei',
        ...
        <section className="py-20 text-center">
          <div className="container mx-auto px-4">
            ...
            <p className="max-w-3xl mx-auto text-lg text-muted-foreground">
              We get it. You need to create more content to grow. But who has the time? Content Forge was born from this exact frustration. We're a team of marketers, engineers, and AI enthusiasts dedicated to building tools that automate the grind, so you can focus on strategy.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground">
                  That "what if" became our obsession. After months of development, Content Forge was born. It's the tool we always wished we had, and now we're sharing it with the world.
                </p>
              </div>
              <div>
                <Image
        ...
        <section id="cta" className="py-20 bg-card">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="max-w-2xl mx-auto text-lg text-muted-foreground mb-8">
              Ready to see how Content Forge can transform your workflow? Start creating smarter, not harder.
            </p>
