...
export default function BulkBlogGeneratorLandingPage() {
  ...
  const pageSchema = {
      ...
      "name": "Bulk AI Blog Generator",
      "applicationCategory": "Productivity",
      "operatingSystem": "Web",
      "description": "Generate multiple high-quality, SEO-optimized blog posts at once from a list of titles. Perfect for agencies and content marketers.",
      "offers": {
        "@type": "Offer",
        "price": "0",
        "priceCurrency": "USD"
