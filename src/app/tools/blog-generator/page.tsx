...
export default function BlogGeneratorLandingPage() {
  ...
  const pageSchema = {
      ...
      "name": "AI Blog Post Generator for WordPress Agencies",
      "applicationCategory": "Productivity",
      "operatingSystem": "Web",
      "description": "Generate high-quality, SEO-optimized blog posts for your WordPress agency or clients in minutes. Automate your content creation workflow and overcome writer's block.",
      "offers": {
        "@type": "Offer",
        "price": "0",
        "priceCurrency": "USD"
