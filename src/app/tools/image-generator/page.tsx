...
export default function ImageGeneratorLandingPage() {
  ...
  const pageSchema = {
      ...
      "name": "AI Image Generator & Inserter for WordPress",
      "applicationCategory": "Design",
      "operatingSystem": "Web",
      "description": "Analyze your blog content to find and insert perfectly relevant, optimized, and cropped images directly into your WordPress posts.",
      "offers": {
        "@type": "Offer",
        "price": "0",
        "priceCurrency": "USD"
