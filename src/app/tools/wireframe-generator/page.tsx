...
export default function WireframeGeneratorLandingPage() {
  ...
  const pageSchema = {
      ...
      "name": "AI Wireframe Generator for HTML & CSS",
      "applicationCategory": "Developer",
      "operatingSystem": "Web",
      "description": "Generate visually rich, interactive wireframes with professional copywriting and a full HTML & CSS structure from a single prompt.",
      "offers": {
        "@type": "Offer",
        "price": "0",
        "priceCurrency": "USD"
          ...
          <section className="py-20 text-center">
            <div className="container mx-auto px-4">
              <h1 className="text-4xl md:text-6xl font-headline font-bold mb-4 tracking-tight">
                AI Wireframe Generator for HTML & CSS
              </h1>
