...
export default function ContentIdeasLandingPage() {
  ...
  const pageSchema = {
      ...
      "operatingSystem": "Web",
      "description": "Generate an endless supply of high-potential, SEO-friendly blog topics in seconds. Overcome writer's block and discover untapped keywords for your niche.",
      "offers": {
        "@type": "Offer",
        "price": "0",
        "priceCurrency": "USD"
