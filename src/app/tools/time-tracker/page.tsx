...
export default function TimeTrackerLandingPage() {
  ...
  const pageSchema = {
      ...
      "name": "Time Tracking and Invoicing for Freelancers",
      "applicationCategory": "Business",
      "operatingSystem": "Web",
      "description": "Log every billable minute with our advanced time tracker, add detailed notes, and ensure you and your clients are always on the same page.",
      "offers": {
        "@type": "Offer",
        "price": "0",
        "priceCurrency": "USD"
