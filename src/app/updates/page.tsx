...
export default function UpdatesPage() {
    const pageSchema = {
        ...
        "description": "A comprehensive list of all the powerful AI tools and features available in the Nabih toolkit for web agencies and creators.",
        "url": "https://nabih.ai/updates"
    };
