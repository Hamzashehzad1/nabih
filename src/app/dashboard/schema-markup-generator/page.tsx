  ...
  return (
    <div className="space-y-8">
      ...
      <Alert>
        ...
        <AlertDescription>
          Generate the schema, copy the code, and paste it into the <code>&lt;head&gt;</code> section of your webpage's HTML.
          Many WordPress SEO plugins also have a field for custom schema.
        </AlertDescription>
      </Alert>
          ...
          <CardContent>
            <Tabs defaultValue="article" onValueChange={setActiveTab}>
              ...
              <TabsContent value="faq" className="space-y-4 pt-4">
                ...
                <Button variant="outline" onClick={() => append({ question: '', answer: '' })}>
          ...
          <CardHeader>
            <div className="flex justify-between items-center">
              ...
              <Button variant="outline" size="sm" onClick={copyToClipboard}>
                <Copy className="mr-2" /> Copy Script
              </Button>
            </div>
